...
pub const efuse_dev_t = extern struct {
    ...
    pgm_data1: efuse_pgm_data1_reg_t = std.mem.zeroes(efuse_pgm_data1_reg_t),
    pgm_data2: efuse_pgm_data2_reg_t = std.mem.zeroes(efuse_pgm_data2_reg_t),
    pgm_data3: efuse_pgm_data3_reg_t = std.mem.zeroes(efuse_pgm_data3_reg_t),
    pgm_data4: efuse_pgm_data4_reg_t = std.mem.zeroes(efuse_pgm_data4_reg_t),
    pgm_data5: efuse_pgm_data5_reg_t = std.mem.zeroes(efuse_pgm_data5_reg_t),
    pgm_data6: efuse_pgm_data6_reg_t = std.mem.zeroes(efuse_pgm_data6_reg_t),
    pgm_data7: efuse_pgm_data7_reg_t = std.mem.zeroes(efuse_pgm_data7_reg_t),
    pgm_check_value0: efuse_pgm_check_value0_reg_t = std.mem.zeroes(efuse_pgm_check_value0_reg_t),
    pgm_check_value1: efuse_pgm_check_value1_reg_t = std.mem.zeroes(efuse_pgm_check_value1_reg_t),
    pgm_check_value2: efuse_pgm_check_value2_reg_t = std.mem.zeroes(efuse_pgm_check_value2_reg_t),
    rd_wr_dis: efuse_rd_wr_dis_reg_t = std.mem.zeroes(efuse_rd_wr_dis_reg_t),
    rd_repeat_data0: efuse_rd_repeat_data0_reg_t = std.mem.zeroes(efuse_rd_repeat_data0_reg_t),
    rd_repeat_data1: efuse_rd_repeat_data1_reg_t = std.mem.zeroes(efuse_rd_repeat_data1_reg_t),
    rd_repeat_data2: efuse_rd_repeat_data2_reg_t = std.mem.zeroes(efuse_rd_repeat_data2_reg_t),
    rd_repeat_data3: efuse_rd_repeat_data3_reg_t = std.mem.zeroes(efuse_rd_repeat_data3_reg_t),
    rd_repeat_data4: efuse_rd_repeat_data4_reg_t = std.mem.zeroes(efuse_rd_repeat_data4_reg_t),
    rd_mac_spi_sys_0: efuse_rd_mac_spi_sys_0_reg_t = std.mem.zeroes(efuse_rd_mac_spi_sys_0_reg_t),
    rd_mac_spi_sys_1: efuse_rd_mac_spi_sys_1_reg_t = std.mem.zeroes(efuse_rd_mac_spi_sys_1_reg_t),
    rd_mac_spi_sys_2: efuse_rd_mac_spi_sys_2_reg_t = std.mem.zeroes(efuse_rd_mac_spi_sys_2_reg_t),
    rd_mac_spi_sys_3: efuse_rd_mac_spi_sys_3_reg_t = std.mem.zeroes(efuse_rd_mac_spi_sys_3_reg_t),
    rd_mac_spi_sys_4: efuse_rd_mac_spi_sys_4_reg_t = std.mem.zeroes(efuse_rd_mac_spi_sys_4_reg_t),
    rd_mac_spi_sys_5: efuse_rd_mac_spi_sys_5_reg_t = std.mem.zeroes(efuse_rd_mac_spi_sys_5_reg_t),
    rd_sys_part1_data0: efuse_rd_sys_part1_data0_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data0_reg_t),
    rd_sys_part1_data1: efuse_rd_sys_part1_data1_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data1_reg_t),
    rd_sys_part1_data2: efuse_rd_sys_part1_data2_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data2_reg_t),
    rd_sys_part1_data3: efuse_rd_sys_part1_data3_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data3_reg_t),
    rd_sys_part1_data4: efuse_rd_sys_part1_data4_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data4_reg_t),
    rd_sys_part1_data5: efuse_rd_sys_part1_data5_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data5_reg_t),
    rd_sys_part1_data6: efuse_rd_sys_part1_data6_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data6_reg_t),
    rd_sys_part1_data7: efuse_rd_sys_part1_data7_reg_t = std.mem.zeroes(efuse_rd_sys_part1_data7_reg_t),
    rd_usr_data0: efuse_rd_usr_data0_reg_t = std.mem.zeroes(efuse_rd_usr_data0_reg_t),
    rd_usr_data1: efuse_rd_usr_data1_reg_t = std.mem.zeroes(efuse_rd_usr_data1_reg_t),
    rd_usr_data2: efuse_rd_usr_data2_reg_t = std.mem.zeroes(efuse_rd_usr_data2_reg_t),
    rd_usr_data3: efuse_rd_usr_data3_reg_t = std.mem.zeroes(efuse_rd_usr_data3_reg_t),
    rd_usr_data4: efuse_rd_usr_data4_reg_t = std.mem.zeroes(efuse_rd_usr_data4_reg_t),
    rd_usr_data5: efuse_rd_usr_data5_reg_t = std.mem.zeroes(efuse_rd_usr_data5_reg_t),
    rd_usr_data6: efuse_rd_usr_data6_reg_t = std.mem.zeroes(efuse_rd_usr_data6_reg_t),
    rd_usr_data7: efuse_rd_usr_data7_reg_t = std.mem.zeroes(efuse_rd_usr_data7_reg_t),
    rd_key0_data0: efuse_rd_key0_data0_reg_t = std.mem.zeroes(efuse_rd_key0_data0_reg_t),
    rd_key0_data1: efuse_rd_key0_data1_reg_t = std.mem.zeroes(efuse_rd_key0_data1_reg_t),
    rd_key0_data2: efuse_rd_key0_data2_reg_t = std.mem.zeroes(efuse_rd_key0_data2_reg_t),
    rd_key0_data3: efuse_rd_key0_data3_reg_t = std.mem.zeroes(efuse_rd_key0_data3_reg_t),
    rd_key0_data4: efuse_rd_key0_data4_reg_t = std.mem.zeroes(efuse_rd_key0_data4_reg_t),
    rd_key0_data5: efuse_rd_key0_data5_reg_t = std.mem.zeroes(efuse_rd_key0_data5_reg_t),
    rd_key0_data6: efuse_rd_key0_data6_reg_t = std.mem.zeroes(efuse_rd_key0_data6_reg_t),
    rd_key0_data7: efuse_rd_key0_data7_reg_t = std.mem.zeroes(efuse_rd_key0_data7_reg_t),
    rd_key1_data0: efuse_rd_key1_data0_reg_t = std.mem.zeroes(efuse_rd_key1_data0_reg_t),
    rd_key1_data1: efuse_rd_key1_data1_reg_t = std.mem.zeroes(efuse_rd_key1_data1_reg_t),
    rd_key1_data2: efuse_rd_key1_data2_reg_t = std.mem.zeroes(efuse_rd_key1_data2_reg_t),
    rd_key1_data3: efuse_rd_key1_data3_reg_t = std.mem.zeroes(efuse_rd_key1_data3_reg_t),
    rd_key1_data4: efuse_rd_key1_data4_reg_t = std.mem.zeroes(efuse_rd_key1_data4_reg_t),
    rd_key1_data5: efuse_rd_key1_data5_reg_t = std.mem.zeroes(efuse_rd_key1_data5_reg_t),
    rd_key1_data6: efuse_rd_key1_data6_reg_t = std.mem.zeroes(efuse_rd_key1_data6_reg_t),
    rd_key1_data7: efuse_rd_key1_data7_reg_t = std.mem.zeroes(efuse_rd_key1_data7_reg_t),
    rd_key2_data0: efuse_rd_key2_data0_reg_t = std.mem.zeroes(efuse_rd_key2_data0_reg_t),
    rd_key2_data1: efuse_rd_key2_data1_reg_t = std.mem.zeroes(efuse_rd_key2_data1_reg_t),
    rd_key2_data2: efuse_rd_key2_data2_reg_t = std.mem.zeroes(efuse_rd_key2_data2_reg_t),
    rd_key2_data3: efuse_rd_key2_data3_reg_t = std.mem.zeroes(efuse_rd_key2_data3_reg_t),
    rd_key2_data4: efuse_rd_key2_data4_reg_t = std.mem.zeroes(efuse_rd_key2_data4_reg_t),
    rd_key2_data5: efuse_rd_key2_data5_reg_t = std.mem.zeroes(efuse_rd_key2_data5_reg_t),
    rd_key2_data6: efuse_rd_key2_data6_reg_t = std.mem.zeroes(efuse_rd_key2_data6_reg_t),
    rd_key2_data7: efuse_rd_key2_data7_reg_t = std.mem.zeroes(efuse_rd_key2_data7_reg_t),
    rd_key3_data0: efuse_rd_key3_data0_reg_t = std.mem.zeroes(efuse_rd_key3_data0_reg_t),
    rd_key3_data1: efuse_rd_key3_data1_reg_t = std.mem.zeroes(efuse_rd_key3_data1_reg_t),
    rd_key3_data2: efuse_rd_key3_data2_reg_t = std.mem.zeroes(efuse_rd_key3_data2_reg_t),
    rd_key3_data3: efuse_rd_key3_data3_reg_t = std.mem.zeroes(efuse_rd_key3_data3_reg_t),
    rd_key3_data4: efuse_rd_key3_data4_reg_t = std.mem.zeroes(efuse_rd_key3_data4_reg_t),
    rd_key3_data5: efuse_rd_key3_data5_reg_t = std.mem.zeroes(efuse_rd_key3_data5_reg_t),
    rd_key3_data6: efuse_rd_key3_data6_reg_t = std.mem.zeroes(efuse_rd_key3_data6_reg_t),
    rd_key3_data7: efuse_rd_key3_data7_reg_t = std.mem.zeroes(efuse_rd_key3_data7_reg_t),
    rd_key4_data0: efuse_rd_key4_data0_reg_t = std.mem.zeroes(efuse_rd_key4_data0_reg_t),
    rd_key4_data1: efuse_rd_key4_data1_reg_t = std.mem.zeroes(efuse_rd_key4_data1_reg_t),
    rd_key4_data2: efuse_rd_key4_data2_reg_t = std.mem.zeroes(efuse_rd_key4_data2_reg_t),
    rd_key4_data3: efuse_rd_key4_data3_reg_t = std.mem.zeroes(efuse_rd_key4_data3_reg_t),
    rd_key4_data4: efuse_rd_key4_data4_reg_t = std.mem.zeroes(efuse_rd_key4_data4_reg_t),
    rd_key4_data5: efuse_rd_key4_data5_reg_t = std.mem.zeroes(efuse_rd_key4_data5_reg_t),
    rd_key4_data6: efuse_rd_key4_data6_reg_t = std.mem.zeroes(efuse_rd_key4_data6_reg_t),
    rd_key4_data7: efuse_rd_key4_data7_reg_t = std.mem.zeroes(efuse_rd_key4_data7_reg_t),
    rd_key5_data0: efuse_rd_key5_data0_reg_t = std.mem.zeroes(efuse_rd_key5_data0_reg_t),
    rd_key5_data1: efuse_rd_key5_data1_reg_t = std.mem.zeroes(efuse_rd_key5_data1_reg_t),
    rd_key5_data2: efuse_rd_key5_data2_reg_t = std.mem.zeroes(efuse_rd_key5_data2_reg_t),
    rd_key5_data3: efuse_rd_key5_data3_reg_t = std.mem.zeroes(efuse_rd_key5_data3_reg_t),
    rd_key5_data4: efuse_rd_key5_data4_reg_t = std.mem.zeroes(efuse_rd_key5_data4_reg_t),
    rd_key5_data5: efuse_rd_key5_data5_reg_t = std.mem.zeroes(efuse_rd_key5_data5_reg_t),
    rd_key5_data6: efuse_rd_key5_data6_reg_t = std.mem.zeroes(efuse_rd_key5_data6_reg_t),
    rd_key5_data7: efuse_rd_key5_data7_reg_t = std.mem.zeroes(efuse_rd_key5_data7_reg_t),
    rd_sys_part2_data0: efuse_rd_sys_part2_data0_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data0_reg_t),
    rd_sys_part2_data1: efuse_rd_sys_part2_data1_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data1_reg_t),
    rd_sys_part2_data2: efuse_rd_sys_part2_data2_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data2_reg_t),
    rd_sys_part2_data3: efuse_rd_sys_part2_data3_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data3_reg_t),
    rd_sys_part2_data4: efuse_rd_sys_part2_data4_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data4_reg_t),
    rd_sys_part2_data5: efuse_rd_sys_part2_data5_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data5_reg_t),
    rd_sys_part2_data6: efuse_rd_sys_part2_data6_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data6_reg_t),
    rd_sys_part2_data7: efuse_rd_sys_part2_data7_reg_t = std.mem.zeroes(efuse_rd_sys_part2_data7_reg_t),
    rd_repeat_err0: efuse_rd_repeat_err0_reg_t = std.mem.zeroes(efuse_rd_repeat_err0_reg_t),
    rd_repeat_err1: efuse_rd_repeat_err1_reg_t = std.mem.zeroes(efuse_rd_repeat_err1_reg_t),
    rd_repeat_err2: efuse_rd_repeat_err2_reg_t = std.mem.zeroes(efuse_rd_repeat_err2_reg_t),
    rd_repeat_err3: efuse_rd_repeat_err3_reg_t = std.mem.zeroes(efuse_rd_repeat_err3_reg_t),
    reserved_18c: u32 = std.mem.zeroes(u32),
    rd_repeat_err4: efuse_rd_repeat_err4_reg_t = std.mem.zeroes(efuse_rd_repeat_err4_reg_t),
    reserved_194: [11]u32 = std.mem.zeroes([11]u32),
    rd_rs_err0: efuse_rd_rs_err0_reg_t = std.mem.zeroes(efuse_rd_rs_err0_reg_t),
    rd_rs_err1: efuse_rd_rs_err1_reg_t = std.mem.zeroes(efuse_rd_rs_err1_reg_t),
    clk: efuse_clk_reg_t = std.mem.zeroes(efuse_clk_reg_t),
    conf: efuse_conf_reg_t = std.mem.zeroes(efuse_conf_reg_t),
    status: efuse_status_reg_t = std.mem.zeroes(efuse_status_reg_t),
    cmd: efuse_cmd_reg_t = std.mem.zeroes(efuse_cmd_reg_t),
    int_raw: efuse_int_raw_reg_t = std.mem.zeroes(efuse_int_raw_reg_t),
    int_st: efuse_int_st_reg_t = std.mem.zeroes(efuse_int_st_reg_t),
    int_ena: efuse_int_ena_reg_t = std.mem.zeroes(efuse_int_ena_reg_t),
    int_clr: efuse_int_clr_reg_t = std.mem.zeroes(efuse_int_clr_reg_t),
    dac_conf: efuse_dac_conf_reg_t = std.mem.zeroes(efuse_dac_conf_reg_t),
    rd_tim_conf: efuse_rd_tim_conf_reg_t = std.mem.zeroes(efuse_rd_tim_conf_reg_t),
    wr_tim_conf1: efuse_wr_tim_conf1_reg_t = std.mem.zeroes(efuse_wr_tim_conf1_reg_t),
    wr_tim_conf2: efuse_wr_tim_conf2_reg_t = std.mem.zeroes(efuse_wr_tim_conf2_reg_t),
    reserved_1f8: u32 = std.mem.zeroes(u32),
...
pub const esp_partition_info_t = extern struct {
    ...
    pos: esp_partition_pos_t = std.mem.zeroes(esp_partition_pos_t),
...
pub const esp_image_metadata_t = extern struct {
    ...
    image: esp_image_header_t = std.mem.zeroes(esp_image_header_t),
...
pub const rtc_retain_mem_t = extern struct {
    partition: esp_partition_pos_t = std.mem.zeroes(esp_partition_pos_t),
...
pub const ets_secure_boot_sig_block = extern struct {
    ...
    image_digest: [32]u8 = std.mem.zeroes([32]u8),
    key: ets_rsa_pubkey_t = std.mem.zeroes(ets_rsa_pubkey_t),
...
pub const bootloader_state_t = extern struct {
    ...
    factory: esp_partition_pos_t = std.mem.zeroes(esp_partition_pos_t),
    @"test": esp_partition_pos_t = std.mem.zeroes(esp_partition_pos_t),
